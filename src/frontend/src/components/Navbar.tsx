...
const Navbar = () => {
    const nav_category: string[] = ["Sports", "Clothes", "Accessories", "Technology"];
    return(
        <nav>
            <div className="flex items-center bg-gray-300 py-3 text-xl">
                ...
                <div className="flex-1 flex item-center">
                    ...
                    <img src={search} alt="search" className="flex-none bg-yellow-600 px-3"></img>
                </div>
            ...
            <div className="flex items-center bg-gray-100 py-1">
                {nav_category.map(element =>
                    <p className="px-8 hover:text-black text-gray-600 font-bold">{element}</p>
                )}
            </div>
        </nav>
    );
